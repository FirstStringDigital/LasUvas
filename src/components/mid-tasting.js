...
export default () => (
    <StaticQuery query={graphql`
        ...
        render={data => (
            ...
            <a className="btn" href="https://calendly.com/elevateloscabos/las-uvas-wine-tasting"  onclick="Calendly.initPopupWidget({url: 'https://calendly.com/elevateloscabos/las-uvas-wine-tasting'});return false;">BOOK WINE + NOSCH</a>
            {/*Calendly*/}
            </div>
        )}
        />
