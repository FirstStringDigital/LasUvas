...
export default () => (
    <StaticQuery query={graphql`
        ...
        render={data => (
            ...
            <a className="btn" href="https://calendly.com/lasuvas/wine-nosch"  onclick="Calendly.initPopupWidget({url: 'https://calendly.com/lasuvas/wine-nosch'});return false;">BOOK WINE + NOSCH</a>
            {/*Calendly*/}
            </div>
        )}
        />
