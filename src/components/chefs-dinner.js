...
export default () => (
    <StaticQuery query={graphql`
        ...
        render={data => (
            ...
            <a className="btn" href="https://calendly.com/lasuvas/chefs-dinner"  onclick="Calendly.initPopupWidget({url: 'https://calendly.com/lasuvas/chefs-dinner'});return false;">BOOK CHEF'S DINNER</a>
            {/*Calendly*/}
            </div>
        )}
        />
