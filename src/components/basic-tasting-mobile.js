...
export default () => (
    <StaticQuery query={graphql`
        ...
        render={data => (
            ...
            <a className="btn" href="https://calendly.com/lasuvas/basic-tasting"  onclick="Calendly.initPopupWidget({url: 'https://calendly.com/lasuvas/basic-tasting'});return false;">BOOK BASIC TASTING</a>
            {/*Calendly*/}
            </div>
        )}
        />
